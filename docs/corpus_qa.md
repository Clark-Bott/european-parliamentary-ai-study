...
**Rebuild note (2026-09-24):** An updated full rebuild of the same three archived ZIP checksums emitted 1,243,606 records / 75,392,623 words (393,565 records / 66,401,901 words at 40 words or more). A controlled rebuild with the pre-role parser at commit `6e5bb69` reproduced the same 1,243,606 IDs and text; the only difference was `speaker_role` on 419,188 rows. The earlier four-output run tabulated below reported 218 fewer records and 28,133 fewer words. It is not reproducible from the verified archives with either parser and remains a historical execution discrepancy, not evidence of a current text difference. See `data/manifests/france_parser_comparison.json`. The current French Pangram 4 per-item list-price estimate is 847,941 rounded 100-word units × $0.05 = **$42,397.05** before cache hits or discounts.
