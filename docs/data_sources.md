...
| Poland — Sejm | Official API documents proceedings, transcript statement lists, individual statement bodies, and [whole-day stenographic PDFs](poland_acquisition_options.md).[15][16][19] | Local build through 2026-09-25: 97,513 interventions / 32,231,985 words; disk-backed QA passed, raw coverage audit found no absent bodies, and live proceedings indexes matched the 480 cached target days. [Poland QA](poland_corpus_qa.md). | The provenance manifest has no entries for 2,458 cached statement bodies. One of ten cached-source screening records is a partial text match, and human boundary review is still open. The PDF archive is an alternative format, not a validated replacement parser. |
