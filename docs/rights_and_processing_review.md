...
| Poland | The [official Sejm API documentation](https://api.sejm.gov.pl/sejm.html) lists transcript and statement endpoints, but does not establish a transcript-specific license. The [2021 public-sector information reuse statute](https://api.sejm.gov.pl/eli/acts/DU/2021/1641/text.html) is a general legal framework, not proof that this endpoint's transcripts may be sent to a third-party US processor. A Sejm-specific reuse notice was not located in this review. | **Unresolved.** Obtain Sejm-specific terms or written confirmation and review the Pangram processing purpose. |
